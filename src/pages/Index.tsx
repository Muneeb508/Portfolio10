      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              <img
                src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=1000&q=80"
                alt="John Doe"
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-4">
                I'm John Doe, specializing in WordPress and front-end development
              </h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg border border-border shadow-sm">
              ...
              <p className="text-muted-foreground mb-4">
                "John developed a custom WordPress theme for our e-commerce store that exceeded our expectations. His attention to detail and technical expertise made our website stand out from competitors."
              </p>
            ...
            <div className="bg-white p-6 rounded-lg border border-border shadow-sm">
              ...
              <p className="text-muted-foreground mb-4">
                "Working with John was a pleasure. He quickly understood our business needs and delivered a clean, responsive website that has significantly improved our online presence and lead generation."
              </p>
              <div className="flex items-center">
                <div className="mr-4">
                  <div className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center text-primary font-semibold">
